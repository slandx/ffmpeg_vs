...
#define FFMPEG_CONFIGURATION "--toolchain=msvc --arch=x86 --target-os=win32 --enable-cross-compile --disable-static --enable-shared --disable-ffplay --disable-ffprobe --disable-ffserver --disable-doc --disable-doc --disable-debug --extra-cflags=-MT --extra-cxxflags=-MT --extra-ldflags='/nodefaultlib:msvcrt.lib' --prefix=/local32/ffmpeg"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2016
#define FFMPEG_DATADIR "/local32/ffmpeg/share/ffmpeg"
#define AVCONV_DATADIR "/local32/ffmpeg/share/ffmpeg"
